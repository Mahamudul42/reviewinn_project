class Review {
  ...
  // CopyWith method for updating review state
  Review copyWith({
    int? reviewId,
    String? title,
    String? content,
    ...
    return Review(
      ...
      entityAvatar: entityAvatar ?? this.entityAvatar,
      entityRootCategoryName: entityRootCategoryName ?? this.entityRootCategoryName,
      entityRootCategoryId: entityRootCategoryId ?? this.entityRootCategoryId,
      entityRootCategoryIcon: entityRootCategoryIcon ?? this.entityRootCategoryIcon,
      entityFinalCategoryName: entityFinalCategoryName ?? this.entityFinalCategoryName,
      entityFinalCategoryId: entityFinalCategoryId ?? this.entityFinalCategoryId,
      entityFinalCategoryIcon: entityFinalCategoryIcon ?? this.entityFinalCategoryIcon,
      entityReviewCount: entityReviewCount ?? this.entityReviewCount,
      entityAverageRating: entityAverageRating ?? this.entityAverageRating,
