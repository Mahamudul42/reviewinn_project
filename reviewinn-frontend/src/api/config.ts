...
export const API_ENDPOINTS = {
  ...
  CIRCLES: {
    ...
    INVITE: (id: string) => `/circles/${id}/invite`,
    MEMBERS: (id: string) => `/circles/${id}/members`,
    INVITES_RECEIVED: '/circles/invites/received',
    INVITES_SENT: '/circles/invites/sent',
    RESPOND_INVITE: (id: string) => `/circles/invite/${id}/respond`,
    SUGGESTIONS: '/circles/suggestions',
    ANALYTICS: '/circles/analytics',
    UPDATE_TRUST_LEVEL: (connectionId: string) => `/circles/member/${connectionId}/trust-level`,
    REMOVE_MEMBER: (connectionId: string) => `/circles/member/${connectionId}`,
    DISMISS_SUGGESTION: (suggestionId: string) => `/circles/suggestions/${suggestionId}/dismiss`,
    ADD_TO_CIRCLE: '/circles/add-user',
