...
interface AddEntityPageLayoutProps {
  children: React.ReactNode;
  className?: string;
}

/**
 * Add Entity Page Layout with reused left/right panels from homepage
 * Only the middle panel content is different (entity creation specific)
 */
const AddEntityPageLayout: React.FC<AddEntityPageLayoutProps> = ({ 
  children, 
  className = ''
}) => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100" style={{ zoom: '0.9' }}>
      <div className="flex justify-center">
        <div className="grid grid-cols-[420px_1fr_420px] w-full max-w-screen-xl h-screen">
          ...
          {/* Center Content - Entity Creation specific */}
...
export default AddEntityPageLayout;