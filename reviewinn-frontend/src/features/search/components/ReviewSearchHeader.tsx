...
interface ReviewSearchHeaderProps {
  query: string;
...
const ReviewSearchHeader: React.FC<ReviewSearchHeaderProps> = ({
  query,
  searchType,
  onQueryChange,
  onTypeChange,
  ...
  // Mock search suggestions for reviews
  ...
  return (
    <div className="bg-white border-b border-gray-200 sticky top-0 z-40">
      <div className="px-6 py-4">
        {/* Main Search Bar - Entity Style Layout */}
        <div className="flex items-center justify-center space-x-3 mb-4">
          <div className="relative flex-1 max-w-2xl">
            ...
            <div className={`flex items-center border-2 rounded-full overflow-hidden transition-all duration-200 ${
              ...
              <div className="flex-1 relative">
                <input
                  ref={inputRef}
                  type="text"
                  className="w-full px-4 py-3 text-base outline-none pr-10"
              ...
              <div className="flex items-center border-l border-gray-300">
                <button 
                  onClick={onSearch}
                  className="px-6 py-3 bg-gray-50 hover:bg-gray-100 transition-colors"
                >
            ...
            {showSuggestions && suggestions.length > 0 && (
              <div 
                ref={suggestionsRef}
                className="absolute top-full left-0 right-0 bg-white border border-gray-200 rounded-xl shadow-lg mt-1 py-2 z-50"
              >
...
export default ReviewSearchHeader;