  ...
  return (
    <div className={`p-4 shadow-md rounded-lg ${cardBg}`}>
      ...
      <button 
        ...
        className="w-full mt-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold shadow-lg hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-base active:scale-95"
        aria-label="Leave a review to earn points and increase your level"
        type="button"
      >
        Leave a Review
      </button>
