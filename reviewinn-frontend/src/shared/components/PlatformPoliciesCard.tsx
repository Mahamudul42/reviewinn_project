  ...
  return (
    ...
    <div className="p-4 shadow-md rounded-lg bg-white hover:shadow-2xl transition-all duration-500 transform hover:scale-[1.02]">
      ...
      <div className="text-center mb-4">
        ...
        <h3 className="text-lg font-black bg-gradient-to-r from-green-600 via-emerald-600 to-green-800 bg-clip-text text-transparent mt-3">
          Platform Policies
        </h3>
        <div className="w-10 h-0.5 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full mx-auto mt-2"></div>
      </div>
