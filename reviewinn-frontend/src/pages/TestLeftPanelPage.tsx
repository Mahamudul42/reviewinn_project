...
import TestLeftPanel from '../features/common/components/TestLeftPanel';
...
/**
 * Test Left Panel Page
 * Uses exact same styling as TestHomePage but shows only left panel
 * Completely independent for testing engagement-based data
 */
const TestLeftPanelPage: React.FC = () => {
  return (
...
export default memo(TestLeftPanelPage);